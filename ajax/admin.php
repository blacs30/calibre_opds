...
$concosAuthorUri = isset($_POST['concosAuthorUri']) ? $_POST['concosAuthorUri'] : 'https://github.com/blacs30/calibre_opds';
$concosAuthorEmail = isset($_POST['concosAuthorEmail']) ? $_POST['concosAuthorEmail'] : 'github@lisowski-developent.de';
